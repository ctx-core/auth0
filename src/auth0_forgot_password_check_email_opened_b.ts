...
export const auth0_forgot_password_check_email_opened_b:auth0_forgot_password_check_email_opened_b_T = _b('auth0_forgot_password_check_email_opened', (
	ctx:auth0_forgot_password_check_email_opened_ctx_I
)=>
