...
import { auth0_token_json_b, auth0_token_json_ctx_I, auth0_token_json_T } from './auth0_token_json_b'
export const in_auth0_token_b:in_auth0_token_b_T = _b('in_auth0_token', (
	ctx:in_auth0_token_ctx_I
)=>
	derived(
