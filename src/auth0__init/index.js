...
export function auth0__init(
	...
	AUTH0_CLIENT_ID__set(ctx, props.AUTH0_CLIENT_ID || import_meta_env_().AUTH0_CLIENT_ID)
	AUTH0_CLIENT_SECRET__set(ctx, props.AUTH0_CLIENT_SECRET || import_meta_env_().AUTH0_CLIENT_ID)
	AUTH0_DOMAIN__set(ctx, props.AUTH0_DOMAIN || import_meta_env_().AUTH0_DOMAIN)
}
