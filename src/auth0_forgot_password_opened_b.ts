...
export interface auth0_forgot_password_opened_ctx_I
	extends auth0_opened_ctx_I {
	auth0_forgot_password_opened?:auth0_forgot_password_opened_T
}
export const auth0_forgot_password_opened_b = _b<auth0_forgot_password_opened_ctx_I, typeof key>(key, ctx=>
