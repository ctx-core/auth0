...
import { auth0__token$_ } from '../auth0__token$_/index.js'
import { auth0__userinfo__GET__fetch2 } from '../auth0__userinfo__GET__fetch/index.js'
import { auth0__userinfo_token$_ } from '../auth0__userinfo_token$_/index.js'
import { AUTH0_DOMAIN$_ } from '../AUTH0_DOMAIN$_/index.js'
...
export const [
	...
	setter_computed_([
		...
		AUTH0_DOMAIN$_(ctx), auth0__token$_(ctx), auth0__userinfo_token$_(ctx),
	], (
		[
