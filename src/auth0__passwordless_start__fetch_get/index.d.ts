...
export declare function auth0__passwordless_start__fetch_get(
	ctx:Ctx, body:auth0__passwordless_start__fetch__body_T
):Promise<[null|Auth0Error, Response]>
export {
	auth0__passwordless_start__fetch_get as post_auth0_passwordless_start,
}
...
export declare type post_auth0_passwordless_start_T = typeof auth0__passwordless_start__fetch_get
