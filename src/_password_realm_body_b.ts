...
export interface _password_realm_body_ctx_I<O extends password_realm_body_T = password_realm_body_T>
	extends _auth0_body_ctx_I {
...
export function _password_realm_body_b<O extends password_realm_body_T = password_realm_body_T>(
	ctx:_password_realm_body_ctx_I<O>
) {
	return _b<_password_realm_body_ctx_I<O>, typeof key>(key, ()=>{
