...
export declare const post_auth0_dbconnections_change_password_b: import("@ctx-core/object").Be<post_auth0_dbconnections_change_password_Ctx, "post_auth0_dbconnections_change_password">;
