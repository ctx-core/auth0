...
export interface auth0_logout_msg_ctx_I extends auth0_token_ctx_I {
    auth0_logout_msg?: auth0_logout_msg_T;
}
export declare const auth0_logout_msg_b: import("@ctx-core/object").Be<auth0_logout_msg_ctx_I, "auth0_logout_msg">;
