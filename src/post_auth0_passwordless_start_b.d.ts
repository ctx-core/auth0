...
export declare const post_auth0_passwordless_start_b: import("@ctx-core/object").Be<auth0_Ctx, "post_auth0_passwordless_start", post_auth0_passwordless_start_T>;
