...
/** @typedef {import('../_types').auth0__oauth_token__fetch__body_T}.auth0__oauth_token__fetch__body_T */
/**
 * @param {import('@ctx-core/object').Ctx}ctx
 * @param {auth0__oauth_token__fetch__body_T}body
 * @return {Promise<[TokenResponse|Auth0Error, Response]>}
 */
export async function auth0__oauth_token__fetch_post(ctx, body) {
