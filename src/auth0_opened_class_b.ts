...
export const auth0_opened_class_b:auth0_opened_class_b_type = _b('auth0_opened_class', ctx=>
	derived(auth0_opened_b(ctx),
		(v:$auth0_opened_type)=>v
	) as auth0_opened_class_type
)
...
export interface auth0_opened_class_b_type extends B<auth0_opened_class_type> {}
export {
