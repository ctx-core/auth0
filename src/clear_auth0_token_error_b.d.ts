...
export declare const clear_auth0_token_error_b: import("@ctx-core/object").Be<clear_auth0_token_error_Ctx, "clear_auth0_token_error", clear_auth0_token_error_T>;
