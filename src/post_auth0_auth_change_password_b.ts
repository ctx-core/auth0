...
import { verify_id_token_header_authorization_fn_b } from './verify_id_token_header_authorization_fn_b'
...
export const post_auth0_auth_change_password_b = _b<auth0_Ctx, typeof key>(key, ctx=>{
	...
	const _verify_id_token_header_authorization = verify_id_token_header_authorization_fn_b(ctx)
