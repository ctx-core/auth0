...
export declare const _verify_id_token_header_authorization_b: import("@ctx-core/object").Be<_verify_id_token_header_authorization_Ctx, "_verify_id_token_header_authorization">;
