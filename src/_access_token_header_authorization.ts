...
export function _access_token_header_authorization(auth0_token: $auth0_token_type): access_token_header_authorization_type {
...
export type access_token_header_authorization_type = string | false | null
