...
export declare const auth0_forgot_password_check_email_opened_b: import("@ctx-core/object").Be<auth0_forgot_password_check_email_opened_ctx_I, "auth0_forgot_password_check_email_opened">;
