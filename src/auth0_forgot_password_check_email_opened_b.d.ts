...
export declare const auth0_forgot_password_check_email_opened_b: import("@ctx-core/object").Be<auth0_Ctx, "auth0_forgot_password_check_email_opened", auth0_forgot_password_check_email_opened_T>;
