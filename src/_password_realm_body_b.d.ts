...
export interface _password_realm_body_ctx_I<O extends password_realm_body_T = password_realm_body_T> extends _auth0_body_ctx_I {
    _password_realm_body?: _password_realm_body_T<O>;
}
export declare function _password_realm_body_b<O extends password_realm_body_T = password_realm_body_T>(ctx: _password_realm_body_ctx_I<O>): _password_realm_body_T<O>;
