...
import { $auth0_opened_T } from './auth0_opened_b';
import type { auth0_Ctx } from './auth0_Ctx';
export declare const auth0_opened_class_b: (ctx: auth0_Ctx, opts?: import("@ctx-core/object")._be_opts_T) => auth0_opened_class_T;
