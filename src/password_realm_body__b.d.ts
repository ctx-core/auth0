...
export declare function password_realm_body__b</*@formatter:off*/ Ctx extends object, Key extends keyof Ctx, Out extends password_realm_body_T = password_realm_body_T>(ctx: Ctx, key: Key, auth0_body_fn: (body: auth0_client_id_optional_body_I) => Out): password_realm_body__T<Out>;
