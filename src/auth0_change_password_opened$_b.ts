...
export const auth0_change_password_opened$_b:B<auth0_change_password_opened$_T> = be_(key, ctx=>
	computed$(auth0_opened$_b(ctx),
		auth0_opened =>
			auth0_opened === 'change_password.js'
	) as auth0_change_password_opened$_T)
export type auth0_change_password_opened$_T = ReadableAtom$<boolean>
export {
