...
import {
	auth0_token_json_b, clear_auth0_token_type, logout_auth0_token_type, set_auth0_token_type
} from './auth0_token_json_b'
...
export const auth0_token_b = _b<auth0_token_type>('auth0_token', ctx=>{
	...
	function schedule_auth0_token_current_validate() {
		const $auth0_token = get(auth0_token)
...
type schedule_auth0_token_current_validate = ()=>void
type set_auth0_token_json_type = (event:{ key:string, newValue:any })=>void
...
type auth0_token_type =
	Readable<$auth0_token_type|null>
	&auth0_token_interface
export {
