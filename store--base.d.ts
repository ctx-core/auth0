...
export declare const b__AUTH0_CLIENT_ID: (ctx?: unknown, opts?: import("@ctx-core/object")._be_opts_type) => Writable<string>;
export declare const __AUTH0_CLIENT_ID: Writable<string>;
export declare const b__AUTH0_DOMAIN: (ctx?: unknown, opts?: import("@ctx-core/object")._be_opts_type) => Writable<string>;
export declare const __AUTH0_DOMAIN: Writable<string>;
export declare const b__AUTH0_URL: (ctx?: unknown, opts?: import("@ctx-core/object")._be_opts_type) => Writable<string>;
...
export declare const b__json__token__auth0: (ctx?: unknown, opts?: import("@ctx-core/object")._be_opts_type) => type__json__token__auth0;
...
export declare const b__token__auth0__: (ctx?: unknown, opts?: import("@ctx-core/object")._be_opts_type) => auth0_token_type;
...
export declare const b__error__token__auth0: (ctx?: unknown, opts?: import("@ctx-core/object")._be_opts_type) => type__error__token__auth0;
...
export declare const b__token__auth0: (ctx?: unknown, opts?: import("@ctx-core/object")._be_opts_type) => auth0_token_type;
...
export declare function b__token__auth0__userinfo__auth0<I = unknown>(ctx?: unknown): Writable<maybe<I, falsy>>;
export declare const __token__auth0__userinfo__auth0: Writable<unknown>;
export declare const b__userinfo__auth0: (ctx?: unknown, opts?: import("@ctx-core/object")._be_opts_type) => Readable<unknown>;
export declare const __userinfo__auth0: Readable<unknown>;
export declare const b__email__auth0: (ctx?: unknown, opts?: import("@ctx-core/object")._be_opts_type) => Readable<string | false>;
export declare const __email__auth0: Readable<string | false>;
export declare const b__email: (ctx?: unknown, opts?: import("@ctx-core/object")._be_opts_type) => Readable<string | false>;
...
export declare const b__opened__auth0: (ctx?: unknown, opts?: import("@ctx-core/object")._be_opts_type) => type__opened__auth0;
