...
export declare const _s__txt__error__token__auth0: (ctx?: any, opts?: any) => import("svelte/store").Readable<any>;
...
export declare const _s__is__loggedin__auth0: (ctx?: any, opts?: any) => import("svelte/store").Readable<boolean>;
export declare const __is__loggedin__auth0: import("svelte/store").Readable<boolean>;
export declare const _s__is__loggedout__auth0: (ctx?: any, opts?: any) => import("svelte/store").Readable<boolean>;
export declare const __is__loggedout__auth0: import("svelte/store").Readable<boolean>;
export declare const _s__class__opened__auth0: (ctx?: any, opts?: any) => import("svelte/store").Readable<any>;
export declare const __class__opened__auth0: import("svelte/store").Readable<any>;
export declare const _s__closed__auth0: (ctx?: any, opts?: any) => import("svelte/store").Readable<boolean>;
export declare const __closed__auth0: import("svelte/store").Readable<boolean>;
export declare const _s__opened__login: (ctx?: any, opts?: any) => import("svelte/store").Readable<boolean>;
export declare const __opened__login: import("svelte/store").Readable<boolean>;
export declare const _s__opened__signup: (ctx?: any, opts?: any) => import("svelte/store").Readable<boolean>;
export declare const __opened__signup: import("svelte/store").Readable<boolean>;
export declare const _s__opened__forgot_password: (ctx?: any, opts?: any) => import("svelte/store").Readable<boolean>;
export declare const __opened__forgot_password: import("svelte/store").Readable<boolean>;
export declare const _s__opened__check_email__forgot_password: (ctx?: any, opts?: any) => import("svelte/store").Readable<boolean>;
