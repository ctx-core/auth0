...
export declare const b__txt__error__token__auth0: (ctx?: object | undefined, opts?: import("@ctx-core/object")._be_opts_type | undefined) => import("svelte/store").Readable<any>;
export declare const __txt__error__token__auth0: import("svelte/store").Readable<any>;
export declare const b__ctx__userinfo__auth0: (ctx?: object | undefined, opts?: import("@ctx-core/object")._be_opts_type | undefined) => import("svelte/store").Readable<{
    userinfo__auth0: maybe<import("./store--base").$type__userinfo__auth0, false | null>;
...
export declare const b__is__loggedin__auth0: (ctx?: object | undefined, opts?: import("@ctx-core/object")._be_opts_type | undefined) => import("svelte/store").Readable<boolean>;
export declare const __is__loggedin__auth0: import("svelte/store").Readable<boolean>;
export declare const b__is__loggedout__auth0: (ctx?: object | undefined, opts?: import("@ctx-core/object")._be_opts_type | undefined) => import("svelte/store").Readable<boolean>;
export declare const __is__loggedout__auth0: import("svelte/store").Readable<boolean>;
export declare const b__class__opened__auth0: (ctx?: object | undefined, opts?: import("@ctx-core/object")._be_opts_type | undefined) => import("svelte/store").Readable<string | number | false | null | undefined>;
export declare const __class__opened__auth0: import("svelte/store").Readable<string | number | false | null | undefined>;
export declare const b__closed__auth0: (ctx?: object | undefined, opts?: import("@ctx-core/object")._be_opts_type | undefined) => import("svelte/store").Readable<boolean>;
export declare const __closed__auth0: import("svelte/store").Readable<boolean>;
export declare const b__opened__login: (ctx?: object | undefined, opts?: import("@ctx-core/object")._be_opts_type | undefined) => import("svelte/store").Readable<boolean>;
export declare const __opened__login: import("svelte/store").Readable<boolean>;
export declare const b__opened__signup: (ctx?: object | undefined, opts?: import("@ctx-core/object")._be_opts_type | undefined) => import("svelte/store").Readable<boolean>;
export declare const __opened__signup: import("svelte/store").Readable<boolean>;
export declare const b__opened__forgot_password: (ctx?: object | undefined, opts?: import("@ctx-core/object")._be_opts_type | undefined) => import("svelte/store").Readable<boolean>;
export declare const __opened__forgot_password: import("svelte/store").Readable<boolean>;
export declare const b__opened__check_email__forgot_password: (ctx?: object | undefined, opts?: import("@ctx-core/object")._be_opts_type | undefined) => import("svelte/store").Readable<boolean>;
export declare const __opened__check_email__forgot_password: import("svelte/store").Readable<boolean>;
export declare const b__opened__change_password: (ctx?: object | undefined, opts?: import("@ctx-core/object")._be_opts_type | undefined) => import("svelte/store").Readable<boolean>;
