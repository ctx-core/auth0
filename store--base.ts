...
] = _ensure__store__instance<Writable<string|falsy>>(
	()=>{
		...
		return [
			...
			Writable<string|falsy>,
			(token__auth0:any)=>void,
			()=>void,
		]
...
type clear__token__auth0 = (value:any)=>void
...
] = _ensure__store__instance<TokenAuth0Readable>(
	ctx=>{
		return [
			assign(
				derived<Readable<string|falsy>, Token__auth0>(
					_s__json__token__auth0(ctx) as unknown as Readable<string|falsy>,
					json__token__auth0=>{
		...
		function clear__token__auth0(value:falsy = false) {
...
export const [_s__token__auth0,
	...
	ctx=>derived<Readable<Token__auth0>, Token__auth0>(
		_s__token__auth0__(ctx)[0],
		token__auth0=>
...
export const [_s__error__token__auth0,
	...
	ctx=>{
		...
		const { open__login__auth0 } = _s__opened__auth0(ctx)[0]
